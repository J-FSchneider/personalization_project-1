...
def join_survey_data(survey, deezer):
    ...
    """
    df = survey.rename(
        columns={'Name': 'user_id', 'Age': 'user_age', 'Gender': 'user_gender',
                 'deezer_id': 'media_id'})
        ...
        if time == None:
            if row['rating'] == 0:
                for i in [1480513129, 1479067262, 1478675619]:
                    new = pd.DataFrame(np.array([[None, i, row['media_id'],
            ...
            for i in [1480513129, 1479067262, 1478675619]:
                new = pd.DataFrame(np.array([[None, i, row['media_id'], None,
            ...
            for i in [('Morning', 1480513129), ('Afternoon', 1479067262),
                      ('Evening', 1478675619)]:
                new = pd.DataFrame(np.array([[None, i[1], row['media_id'],
                                              None, None, None, None, None,
                                              None, 1, user_gender,
                                              row['user_id'], None,
